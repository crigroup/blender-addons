...
class IMPORT_IMAGE_OT_to_plane(Operator, AddObjectHelper):
    ...
    location: FloatVectorProperty(name="Location", default=(0.0,0.0,0.0),
                                    precision=6, description="Plane x,y,z location")

    orientation: FloatVectorProperty(name="Orientation", default=(0.0,0.0,0.0),
                                       precision=6, description="Plane RPY orientation")
